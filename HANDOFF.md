...
- **Emotional Taste Graph** `src/server/taste/` — ♥/✕ (`/api/feedback`) EMA-updates a 16-dim profile; engine blends it into ranking (weight ramps with #interactions), boosts loved, demotes skipped.
